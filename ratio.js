/*! @name @yangkghjh/videojs-aspect-ratio-panel @version 0.0.0 @license MIT */
(function (global, factory) {
  ...
  function (_MenuButton) {
    ...
    _proto.createEl = function createEl() {
      return videojs.dom.createEl("div", {
        className: "vjs-menu-button vjs-menu-button-popup vjs-control vjs-button vjs-resize-but"
      });
    };
  ...
  function (_Component) {
    ...
    function ResizerPanel(player, options) {
      ...
      var radios = [radiosDiv[1], radiosDiv[5], radiosDiv[9], radiosDiv[13], radiosDiv[17]];
      var prev = "origin";
    ...
    _proto.resize = function resize() {
      if (this.aspectRadio != "origin" && this.aspectRadio != "cover") {
        this.player().tech_.el().style.objectFit = "fill";
      } else {
          if(this.aspectRadio == "cover"){
            this.player().tech_.el().style.objectFit = "cover";
          }else{
            this.player().tech_.el().style.objectFit = "contain";
          }
      }
      ...
      if (this.aspectRadio == "origin" || this.aspectRadio == "fill" || this.aspectRadio == "cover") {
